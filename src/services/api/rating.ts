...
export const getRatingTags = (resourceType: string) => {
  return http
    .get<RatingApiResponse<RatingTagsInfo>>(`/ratings/tags?resource_type=${resourceType}`)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const createRatingItem = (data: CreateRatingItemRequest) => {
  return http
    .post<RatingApiResponse<RatingItem>>('/ratings/items', data)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const createRating = (data: CreateRatingRequest) => {
  ...
  return http
    .post<RatingApiResponse<UserRating>>('/ratings', requestData)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const getRatingDetail = (ratingId: string) => {
  return http
    .get<RatingApiResponse<RatingDetailResponse>>(`/ratings/${ratingId}`)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const submitRating = (data: SubmitRatingRequest) => {
  return http
    .post<RatingApiResponse<UserRating>>('/ratings', data)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const updateRatingItem = (itemId: string, data: Partial<CreateRatingItemRequest>) => {
  return http
    .put<RatingApiResponse<RatingItem>>(`/ratings/items/${itemId}`, data)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const deleteRatingItem = (itemId: string) => {
  return http
    .delete<RatingApiResponse<{}>>(`/ratings/items/${itemId}`)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const getResourceList = (params: GetResourceListRequest) => {
  ...
  return http
    .get<RatingApiResponse<ResourceListResponse>>('/ratings/resources/list', queryParams)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const searchResources = (params: SearchResourcesRequest) => {
  ...
  return http
    .get<RatingApiResponse<ResourceListResponse>>('/ratings/resources/search', queryParams)
    .then((response) => {
      return response
    })
    .catch((error) => {
 ...
 * @returns 资源评分统计
 */
export const getResourceStatistics = (resourceType: string, resourceId: string) => {
  return http
    .get<RatingApiResponse<any>>(`/ratings/resources/${resourceType}/${resourceId}/statistics`)
    .then((response) => {
      return response
    })
    .catch((error) => {
...
export const getTopRatedResources = (params: GetTopRatedResourcesRequest = {}) => {
  ...
  return http
    .get<RatingApiResponse<RatableResource[]>>('/ratings/resources/top-rated', queryParams)
    .then((response) => {
      return response
    })
    .catch((error) => {
