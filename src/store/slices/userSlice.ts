...
export const login = createAsyncThunk(
  ...
  async (code: string, { dispatch, getState, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(err?.msg || err?.message || '登录失败');
    }
  },
);
...
export const fetchAboutInfo = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '获取租户信息失败');
    }
  },
);
...
export const loginWithUsername = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '用户名或密码错误');
    }
  },
);
...
export const registerUser = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '注册失败');
    }
  },
);
...
export const fetchCurrentUser = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const err = error as { statusCode?: number; msg?: string; message?: string };
      if (err?.statusCode === 401) {
        Taro.removeStorageSync('token');
      }
      return rejectWithValue(err?.msg || err?.message || '获取用户信息失败');
    }
  },
);
...
export const fetchUserProfile = createAsyncThunk(
  ...
  async (userId: string, { rejectWithValue }) => {
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '获取用户资料失败');
    }
  },
);
...
export const updateUser = createAsyncThunk(
  ...
  async (data: UpdateUserProfileRequest, { dispatch, rejectWithValue }) => {
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '更新失败');
    }
  },
);
...
export const fetchUserStats = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '获取用户统计失败');
    }
  },
);
...
export const fetchFollowersCount = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '获取关注/粉丝总数失败');
    }
  },
);
...
export const fetchCollectionCount = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const err = error as { msg?: string; message?: string };
      return rejectWithValue(err?.msg || err?.message || '获取收藏数量失败');
    }
  },
);
