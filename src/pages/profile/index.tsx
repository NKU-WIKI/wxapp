...
const Profile = () => {
  ...
  if (
    ...
    (statsStatus as any) === 'loading' ||
    (followersCountStatus as any) === 'loading' ||
    (collectionCountStatus as any) === 'loading' ||
    (userPostsState?.postCountLoading as any) === 'pending' ||
              ...
              <View className={styles.statsRow}>
                ...
                <View className={styles.statItem} onClick={handleNavigateToLikes}>
                  <Text className={styles.statValue}>
                    {(userPostsState?.likeCountLoading as any) === 'pending'
                      ? '...'
                      : userPostsState?.likeCount !== null &&
                          userPostsState?.likeCount !== undefined
