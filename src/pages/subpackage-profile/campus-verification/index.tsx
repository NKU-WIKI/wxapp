...
const CampusVerification = () => {
  ...
  if (
    info &&
    (info.verification_status === 'auto_reviewing' ||
      info.verification_status === 'pending_manual_review' ||
    ...
    return (
      <View style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          <ScrollView scrollY style={{ height: '100%' }}>
            <View className={styles.content}>{statusView}</View>
          </ScrollView>
        </View>
      </View>
    )
        ...
        <ScrollView scrollY style={{ height: '100%' }}>
          <View className={styles.content}>
            <View className={styles.formContainer}>
              ...
              >
                {isSubmitting || campusVerificationState.submitStatus === 'loading'
                  ? '提交中...'
                  : '提交认证'}
              </Button>
            </View>
